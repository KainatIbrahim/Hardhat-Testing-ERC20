...
describe("ERC20 mintable token 2", function(){
    beforeEach(async function(){
        [owner, add1, add2, ...addrs] = await ethers.getSigners();
        const ERC20token5 = await ethers.getContractFactory("ERC20token5");
        token = await ERC20token5.deploy();
...
////////////////////Test for token details//////////////////////
    describe("Token Details", function(){
        ...
        const Symbol = "TK5";
        const decimals = 8;
        expect(Name).to.equal("TOKEN5");
        console.log("Token Name= ", Name);
        expect(Symbol).to.equal("TK5");
...
//////////////////////////burn///////////////////////////
    describe("Test Burn Function", function(){
        it("This function should decrease token supply and owner balance", async function(){
            ...
            expect(token.totalsupply())==(supplyBeforeBurn-100);
            expect(token.balanceOf(owner.address))==(ownerBalanceBeforeBurn-100);
